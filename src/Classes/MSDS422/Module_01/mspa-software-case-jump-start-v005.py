...
path_home = "C:\Projects\Python-Playground\src\Classes\MSDS422\Module_01"
path_work = ""

data_path = os.path.join( path_home, "data", "mspa-survey-data.csv")
...
scatter_plot = axis.scatter(survey_df['My_R'], 
    ...
    facecolors = 'none', 
    edgecolors = 'blue') 
plt.savefig( os.path.join( path_home, 'plot-scatter-r-python.pdf'), 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None)  
