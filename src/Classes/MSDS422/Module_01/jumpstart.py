...
DATA_PATH = "C:\Projects\Python-Playground\src\Classes\MSDS422\Module_01"
...
def corr_chart(df_corr):
    ...
    plt.savefig( DATA_PATH + 'plot-corr-map.pdf', 
...
valid_survey_input = pd.read_csv(DATA_PATH)
...
scatter_plot = axis.scatter(survey_df['My_R'], 
    ...
    facecolors = 'none', 
    edgecolors = 'blue') 
plt.savefig( DATA_PATH + 'plot-scatter-r-python.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None)
...
for i in range(5):
    for j in range(5):
        if i != j:
            ...
            facecolors = 'none', 
            edgecolors = 'blue') 
            plt.savefig(DATA_PATH + file_title + '.pdf', 
                bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
                orientation='portrait', papertype=None, format=None, 
                transparent=True, pad_inches=0.25, frameon=None)  
...
unscaled_fig.savefig(DATA_PATH + 'Transformation-Unscaled' + '.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None)
...
standard_fig.savefig(DATA_PATH + 'Transformation-StandardScaler' + '.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None)  
...
minmax_fig.savefig(DATA_PATH + 'Transformation-MinMaxScaler' + '.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None) 
...
log_fig.savefig( DATA_PATH + 'Transformation-NaturalLog' + '.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='w', edgecolor='b', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None)  
