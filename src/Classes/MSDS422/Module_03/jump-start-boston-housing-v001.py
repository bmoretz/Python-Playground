...
DATA_FILE = "bank.csv"
DATA_PATH = "datasets"
PROJECT_PATH = "Python-Playground\src\Classes\MSDS422\Module_03"

def get_data_file( path_home = PATH_HOME, path_work = PATH_WORK, data_path = DATA_PATH, data_file = DATA_FILE):
	path_root = ( os.path.exists( path_home ) and path_home ) or path_work
	project_path = os.path.join( path_root, PROJECT_PATH )
	return os.path.join( project_path, DATA_PATH, data_file )
